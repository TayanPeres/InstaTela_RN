...
export default function List(props){
  ...
  function carregaIcone(likeada){
    //está likeada true entao coloca o item com coração preenchido
    return likeada ? require('../img/likeada.png') :
    //n está likeada coloca o coração normal
    require('../img/like.png')
  }

  function mostraLikes(likers){
    /* se o link for = 0 dar o return */
    if(likers === 0){
      return;
    }

    return( 
      /* se tiver likes, se for se for maior mostra curtidas, menor que 1 coloca curtida,  */
